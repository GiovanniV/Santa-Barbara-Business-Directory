...
class Yaml {
	 ...
	 * Turns the given array into a Yaml string

	 * 

	 * @param   string  $array     the PHP array to turn into Yaml

	 * @param   int     $indent    the number of spaces to use for indent (default 2)
